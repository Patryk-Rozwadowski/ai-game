...
parcelRequire = (function (modules, cache, entry, globalName) {
...
})(
  {
    ...
    'Models/Player.model.js': [
          ...
          _createClass(Player, [
            {
              ...
              value: function calcFitness() {
                ...
                this.fitness =
                  (this.score * this.ballHit) / this.deathPenalty +
            ...
            },
            {
              ...
              value: function walls_collision() {
                var ROOF =
                  this.ball.y + this.ball.y_speed - this.ball.ballRadius < 0;
                var RIGHT_WALL =
                  this.ball.x + this.ball.x_speed + this.ball.ballRadius >
                  canvasWidth;
                var LEFT_WALL =
      ...
      {
        '../View/Settings.view': 'View/Settings.view.js',
        '../utils/getRandomNumber.util': 'utils/getRandomNumber.util.js',
      },
    ],
    'Models/DNA.model.js': [
      function (require, module, exports) {
    ...
    'Models/Population.model.js': [
        ...
        var Population = /*#__PURE__*/ (function () {
          function Population() {
            ...
            for (var i = 0; i < this.total; i++) {
              this.population[i] = new _Player.default(
                new _DNA.DNA(),
                false,
                new _Ball.default()
              );
          ...
          _createClass(Population, [
            {
              key: 'calculatePopulation',
              value: function calculatePopulation() {
            ...
            {
              key: 'populationLearning',
              value: function populationLearning() {
                var _this = this;

                if (this.population) {
                  this.population.map(function (player, i) {
                    var deathPenalty = _this.population.length;
                    player.start();

                    if (player.dead === true) {
                      player.deathPenalty = deathPenalty;

                      _this.population.splice(i, 1);

                      _this.deadPopulation.push(player);
                    }
                  });
                }
              },
            ...
            {
              key: '_nextGeneration',
              value: function _nextGeneration() {
                console.log('Next generation');
                this.generation++;

                for (var i = 0; i < this.total; i++) {
                  var parentA = this._acceptReject();

                  var parentB = this._acceptReject();

                  if (!parentA)
                    parentA = this.deadPopulation[
                      (0, _getRandomNumber.getRandomNumber)(this.total)
                    ];
                  if (!parentB)
                    parentB = this.deadPopulation[
                      (0, _getRandomNumber.getRandomNumber)(this.total)
                    ];
            ...
            },
            {
              ...
              value: function _getMaxFitness() {
                ...
                try {
                  for (
                    var _iterator = this.deadPopulation[Symbol.iterator](),
                      _step;
            ...
            {
              key: '_getAvgFitnessPerGen',
              value: function _getAvgFitnessPerGen() {
                var fitnessSum = 0;
            ...
            {
              key: '_getWorstFitness',
              value: function _getWorstFitness() {
                var worstFitness = 0;
            ...
            },
            {
              ...
              value: function _calculateFitness() {
                ...
                try {
                  for (
                    var _iterator2 = this.deadPopulation[Symbol.iterator](),
                      _step2;
            ...
            {
              key: '_acceptReject',
              value: function _acceptReject() {
                var escapeLoop = 0;

                while (true) {
                  var partner = this.deadPopulation[
                    (0, _getRandomNumber.getRandomNumber)(this.total)
                  ];
                  var r = Math.floor(Math.random() * this.bestPlayer.fitness);
            ...
            {
              key: '_setMostBallHit',
              value: function _setMostBallHit() {
                ...
                try {
                  for (
                    var _iterator3 = this.deadPopulation[Symbol.iterator](),
                      _step3;
      ...
      },
      {
        ...
        './DNA.model': 'Models/DNA.model.js',
        './Ball.model': 'Models/Ball.model.js',
        '../utils/getRandomNumber.util': 'utils/getRandomNumber.util.js',
      },
    ],
    'View/GameInfo.view.js': [
      function (require, module, exports) {
        'use strict';
        ...
        var populationInformation = document.getElementById(
          'populationInformation'
        );

        var WriteGameInfo = function WriteGameInfo(
          generation,
          population,
          bestPlayer,
          worstFitness,
          ...
          populationInformation.innerHTML = '\n      <p class="h2">Generation: '
            .concat(generation, '</p>\n      \n      <p class="h4">')
            .concat(
              bestPlayer
                ? 'Best fitness: '.concat(fitness)
                : 'No best fitness yet!',
              '</p>\n      <p class="h4">'
            )
            .concat(
              worstFitness
                ? 'Worst fitness: '.concat(worstFitness)
                : 'No worst fitness yet!',
              '</h2>\n      <p class="h4">'
            )
            .concat(
              avgFitness
                ? 'Average fitness per generation: '.concat(avgFitness)
                : 'No average fitness yet!',
              '</h2>\n      <p class="h4">'
            )
            .concat(
              mostBallHit
                ? 'Most ball hit: '.concat(mostBallHit)
                : 'No best ball hit yet!',
              '</h2>\n      <p class="h4">Mutation ratio: '
            )
            .concat(
              mutationRatio * 100,
              '%</h2>\n      <p class="h2">Alive population: '
            )
            .concat(
              population.length,
              '</p>\n      <p class="h2">Dead population: '
            )
            .concat(deadPopulation.length, '</h2>\n    ');
        };
    ...
    'Controller/Game.controller.js': [
      function (require, module, exports) {
        ...
        var _Population = _interopRequireDefault(
          require('../Models/Population.model')
        );
        ...
        var Game = /*#__PURE__*/ (function () {
          function Game() {
            ...
            this.interval = setInterval(function () {
              if (!_this.isPaused) {
                _Settings.Settings.ctx.clearRect(
                  0,
                  0,
                  canvasWidth,
                  canvasHeight
                ...
                (0, _GameInfo.WriteGameInfo)(
                  _this.game.generation,
                  _this.game.population,
                  _this.game.bestPlayer,
                  _this.game.worstFitness,
                  _this.game.avgFitness,
                  _this.game.mostBallHit,
                  _this.game.mutationRatio,
                  _this.game.deadPopulation
                );

                _this._whenPopulationIsNotEmpty();

                _this._whenPopulationIsEmpty();
              }
            }, this.learningSpeed);
          }
          ...
          _createClass(Game, [
            ...
            {
              key: '_whenPopulationIsNotEmpty',
              value: function _whenPopulationIsNotEmpty() {
                this.game.populationLearning();
              },
            },
            {
              key: '_whenPopulationIsEmpty',
              value: function _whenPopulationIsEmpty() {
                if (this.game.population.length === 0) {
                  this.game.calculatePopulation();
                  this.game.fillHistory();
                  if (this.game.populationHistory.length > 0)
                    (0, _showBtn.showElement)([csvButton]);
                  this.game.deadPopulation = [];
                }
              },
            },
            {
              key: '_getProgressTimeAndDate',
              value: function _getProgressTimeAndDate() {
                var time = new Date();
                var date = new Date();
                return ''
                  ...
                  .concat(date.getDate(), ' ')
                  .concat(time.getHours(), ':')
                  .concat(time.getMinutes());
              },
            },
            {
              key: '_saveToCsv',
              value: function _saveToCsv() {
                var csvRows = Object.keys(this.game.populationHistory[0]).join(
                  ';'
                );
                var csvCols = '';
                var _iteratorNormalCompletion = true;
                ...
                try {
                  for (
                    var _iterator = this.game.populationHistory[
                        Symbol.iterator
                      ](),
                      _step;
                    !(_iteratorNormalCompletion = (_step = _iterator.next())
                    ...
                    csvCols += '\n'
                      .concat(Generation, ';')
                      .concat(Most_Ball_Hit, ';')
                      .concat(Best_Fitness, ';')
                      .concat(Worst_Fitness, ';')
                      .concat(Average_Fitness, ';')
                      .concat(Mutation_Ratio);
                  }
                } catch (err) {
                  _didIteratorError = true;
                  _iteratorError = err;
                ...
                a.setAttribute(
                  'download',
                  ''
                    .concat(this._getProgressTimeAndDate(), ' MR-')
                    .concat(this.game.mutationRatio, ' GN-')
                    .concat(this.game.generation, '.csv')
                );
                a.click();
              },
            },
        ...
        startGameBtn.addEventListener('click', function () {
          ...
          csvButton.addEventListener('click', function () {
            return game._saveToCsv();
          });
        });

        var controlPanel = function controlPanel(gameStarted) {
          if (gameStarted)
            (0, _showBtn.showElement)([controlButtons])([startGameBtn]);
        };
      },
      {
        '../Models/Population.model': 'Models/Population.model.js',
        '../View/Settings.view': 'View/Settings.view.js',
        '../View/GameInfo.view': 'View/GameInfo.view.js',
        '../utils/showBtn.util': 'utils/showBtn.util.js',
      },
    ],
